...
public interface CORCollectionBranchRepository extends JpaRepository<CORCollectionBranch, Long> {
	...
	@Query(value = "SELECT * FROM vw_colbranch where branch_code = :branch_code", nativeQuery = true)
	public List<Object[]> getBranchCollection(@Param("branch_code") String branch);
