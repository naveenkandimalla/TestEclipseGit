...
public interface RecepitStmtDetailsRepository extends JpaRepository<User,Double> {
	...
	List<Object[]> getallreceiptdetails(double recepitno);
   
	@Query(value="call pe_Get_Rcpt_Stmt_Details_Bank_Stmt(?1)",nativeQuery=true)
	List<Object[]> getallstmtdetailsBankstmt(double recepitno);
}
