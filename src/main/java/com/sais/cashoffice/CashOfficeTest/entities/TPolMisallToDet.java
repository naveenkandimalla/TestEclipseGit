...
/**
 * The persistent class for the T_POL_MISALL_TO_DET database table.
 * 
 */
@Entity
@Table(name="T_POL_MISALL_TO_DET")
@NamedQuery(name="TPolMisallToDet.findAll", query="SELECT t FROM TPolMisallToDet t")
public class TPolMisallToDet implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="POL_MISALL_TO_ID")
	...
	public TPolMisallToDet() {
	}

	public double getPolMisallToId() {
		return this.polMisallToId;
	}
