...
/**
 * The persistent class for the T_RCPT_ALLOCATION_SUNDRY database table.
 * 
 */
@Entity
@Table(name="T_RCPT_ALLOCATION_SUNDRY")
@NamedQuery(name="TRcptAllocationSundry.findAll", query="SELECT t FROM TRcptAllocationSundry t")
public class TRcptAllocationSundry implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="RCPT_ALL_SUNDRY_ID")
	private double rcptAllSundryId;
	...
	public TRcptAllocationSundry() {
	}

	public double getRcptAllSundryId() {
		return this.rcptAllSundryId;
	}

	public void setRcptAllSundryId(double rcptAllSundryId) {
		this.rcptAllSundryId = rcptAllSundryId;
	}
