...
/**
 * The persistent class for the T_POL_PARTIAL_MISALL_FROM_DET database table.
 * 
 */
@Entity
@Table(name="T_POL_PARTIAL_MISALL_FROM_DET")
@NamedQuery(name="TPolPartialMisallFromDet.findAll", query="SELECT t FROM TPolPartialMisallFromDet t")
public class TPolPartialMisallFromDet implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="POL_PAR_MISALLOC_FROM_ID")
	...
	public TPolPartialMisallFromDet() {
	}

	public double getPolParMisallocFromId() {
		return this.polParMisallocFromId;
	}
