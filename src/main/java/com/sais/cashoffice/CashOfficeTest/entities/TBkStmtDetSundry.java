...
/**
 * The persistent class for the T_BK_STMT_DET_SUNDRY database table.
 * 
 */
@Entity
@Table(name="T_BK_STMT_DET_SUNDRY")
@NamedQuery(name="TBkStmtDetSundry.findAll", query="SELECT t FROM TBkStmtDetSundry t")
public class TBkStmtDetSundry implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="BK_STMT_DET_SUN_ID")
	private double bkStmtDetSunId;
	...
	public TBkStmtDetSundry() {
	}

	public double getBkStmtDetSunId() {
		return this.bkStmtDetSunId;
	}

	public void setBkStmtDetSunId(double bkStmtDetSunId) {
		this.bkStmtDetSunId = bkStmtDetSunId;
	}
