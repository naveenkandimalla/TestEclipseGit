...
/**
 * The persistent class for the T_BK_STMT_DET_REVERSALS database table.
 * 
 */
@Entity
@Table(name = "T_BK_STMT_DET_REVERSALS")
@NamedQuery(name = "TBkStmtDetReversal.findAll", query = "SELECT t FROM TBkStmtDetReversal t")
public class TBkStmtDetReversal implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "BK_STMT_DET_REV_ID")
	private double bkStmtDetRevId;
	...
	public TBkStmtDetReversal() {
	}

	public double getBkStmtDetRevId() {
		return this.bkStmtDetRevId;
	}

	public void setBkStmtDetRevId(double bkStmtDetRevId) {
		this.bkStmtDetRevId = bkStmtDetRevId;
	}
